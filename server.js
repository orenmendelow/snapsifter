...
const FILM_SIM_MAP = {
  ...
  Eterna: 0x10, ClassicNeg: 0x11, BleachBypass: 0x12, NostalgicNeg: 0x13, RealaACE: 0x14,
};
...
function patchD185Profile(base64Data, uiParams) {
  ...
  if (uiParams.wbShiftR !== undefined) setField(NativeIdx.WBShiftR, uiParams.wbShiftR);
  if (uiParams.wbShiftB !== undefined) setField(NativeIdx.WBShiftB, uiParams.wbShiftB);
